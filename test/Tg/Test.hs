    ...
    describe "startApp" $ do
      ...
      it
        ...
        reverse state `shouldBe`
          ...
          , LOGMSG
              DEBUG
              "Send request to confirmOldUpdates with offset:235800274 https://api.telegram.org/botABC123/getUpdates\n"
    ...
    describe "run" $ do
      it "work with singleton update list with text msg" $ do
        ...
        reverse state `shouldBe`
          ...
          , LOGMSG
              DEBUG
              "Send request to confirmOldUpdates with offset:235800277 https://api.telegram.org/botABC123/getUpdates\n"
          ...
          (concat . replicate 2 $
           [ LOGMSG
               DEBUG
               "Send request to send msg \"love\" to userId 1118947329: https://api.telegram.org/botABC123/sendMessage   JSON body : {chat_id = 1118947329, text = \"love\"}\n"
      ...
      it "work with singleton update list with /help msg" $ do
        ...
        reverse state `shouldBe`
          ...
          , LOGMSG
              DEBUG
              "Send request to send msg \"Hello\" to userId 1118947329: https://api.telegram.org/botABC123/sendMessage   JSON body : {chat_id = 1118947329, text = \"Hello\"}\n"
