  ...
  hspec $ do
    ...
    describe "run" $ do
      ...
      it "throw CheckSendMsgResponseException on unknown sendMsg response" $
        evalStateT (evalStateT (run handle29) initialDB2) [] `shouldThrow`
        isCheckSendMsgResponseException
      it "throw CheckSendMsgResponseException on negative sendMsg response" $
        evalStateT (evalStateT (run handle30) initialDB2) [] `shouldThrow`
        isCheckSendMsgResponseException
      it "throw CheckSendMsgResponseException on other negative sendMsg response" $
        evalStateT (evalStateT (run handle31) initialDB2) [] `shouldThrow`
        isCheckSendMsgResponseException
      it "throw CheckCopyMsgResponseException on unknown copyMsg response" $
        evalStateT (evalStateT (run handle33) initialDB2) [] `shouldThrow`
        isCheckCopyMsgResponseException
      it "throw CheckCopyMsgResponseException on negative copyMsg response" $
        evalStateT (evalStateT (run handle34) initialDB2) [] `shouldThrow`
        isCheckCopyMsgResponseException
      it "throw CheckCopyMsgResponseException on other negative copyMsg response" $
        evalStateT (evalStateT (run handle35) initialDB2) [] `shouldThrow`
        isCheckCopyMsgResponseException
      it "throw CheckSendKeybResponseException on unknown sendKeyboard response" $
        evalStateT (evalStateT (run handle44) initialDB3) [] `shouldThrow`
        isCheckSendKeybResponseException
      it "throw CheckSendKeybResponseException on negative sendKeyboard response" $
        evalStateT (evalStateT (run handle45) initialDB3) [] `shouldThrow`
        isCheckSendKeybResponseException
      it "throw CheckSendKeybResponseException on other negative sendKeyboard response" $
        evalStateT (evalStateT (run handle46) initialDB3) [] `shouldThrow`
        isCheckSendKeybResponseException  
      it "throw CheckConfirmUpdatesResponseException on unknown confirmUpdates response" $
        evalStateT (evalStateT (run handle47) initialDB3) [] `shouldThrow`
        isCheckConfirmUpdatesResponseException
      it "throw CheckConfirmUpdatesResponseException on negative confirmUpdates response" $
        evalStateT (evalStateT (run handle48) initialDB3) [] `shouldThrow`
        isCheckConfirmUpdatesResponseException
      it "throw CheckConfirmUpdatesResponseException on other negative confirmUpdates response" $
        evalStateT (evalStateT (run handle49) initialDB3) [] `shouldThrow`
        isCheckConfirmUpdatesResponseException    
      it "throw SendMsgException on sendMsg ConnectionTimeout" $
        evalStateT (evalStateT (run handle50) initialDB3) [] `shouldThrow`
        isSendMsgException
      it "throw GetUpdatesException on sendMsg ConnectionTimeout" $
        evalStateT (evalStateT (run handle51) initialDB3) [] `shouldThrow`
        isGetUpdatesException 
      it "throw ConfirmUpdatesException on sendMsg ConnectionTimeout" $
        evalStateT (evalStateT (run handle52) initialDB3) [] `shouldThrow`
        isConfirmUpdatesException 
      it "throw SendKeybException on sendMsg ConnectionTimeout" $
        evalStateT (evalStateT (run handle53) initialDB3) [] `shouldThrow`
        isSendKeybException 
      it "throw CopyMsgException on sendMsg ConnectionTimeout" $
        evalStateT (evalStateT (run handle54) initialDB3) [] `shouldThrow`
        isCopyMsgException     
