...
getPhotoServerTest :: Response -> UserId -> StateT [MockAction VkAttachMSG] IO Response
getPhotoServerTest json usId = StateT $ \s -> return (json, VkMock (GOTPhotoSERVER usId) : s)

loadPhotoToServTest :: Response -> ServerUrl -> PicUrl -> ResponseS -> StateT [MockAction VkAttachMSG] IO Response
loadPhotoToServTest json serUrl picUrl bs = StateT $ \s -> return (json, VkMock (LOADPhotoTOSERV serUrl picUrl bs) : s)

savePhotoOnServTest :: Response -> LoadPhotoResp -> StateT [MockAction VkAttachMSG] IO Response
savePhotoOnServTest json loadPhotoResp = StateT $ \s -> return (json, VkMock (SAVEPhotoONSERV loadPhotoResp) : s)

getDocServerTest :: Response -> UserId -> TypeInGetServerReq -> StateT [MockAction VkAttachMSG] IO Response
getDocServerTest json usId type' = StateT $ \s -> return (json, VkMock (GOTDocSERVER usId type') : s)

loadDocToServTest :: Response -> ServerUrl -> DocUrl -> ResponseS -> Extention -> StateT [MockAction VkAttachMSG] IO Response
loadDocToServTest json serUrl docUrl bs ext = StateT $ \s -> return (json, VkMock (LOADDocTOSERV serUrl docUrl bs ext) : s)

saveDocOnServTest :: Response -> LoadDocResp -> Title -> StateT [MockAction VkAttachMSG] IO Response
saveDocOnServTest json loadDocResp title = StateT $ \s -> return (json, VkMock (SAVEDocONSERV loadDocResp title) : s)
...
loadPhotoToServTestEx :: ServerUrl -> PicUrl -> ResponseS -> StateT [MockAction VkAttachMSG] IO Response
...
getDocServerTestEx :: UserId -> TypeInGetServerReq -> StateT [MockAction VkAttachMSG] IO Response
getDocServerTestEx _ _ = App.throwHttpEx

loadDocToServTestEx :: ServerUrl -> DocUrl -> ResponseS -> Extention -> StateT [MockAction VkAttachMSG] IO Response
...
handle2, handle3, handle4, handle5, handle6, handle7, handle8, handle9 :: Handle (StateT [MockAction VkAttachMSG] IO)
...
handle10, handle11, handle12, handle13, handle14, handle15, handle16, handle17, handle18, handle19 :: Handle (StateT [MockAction VkAttachMSG] IO)
