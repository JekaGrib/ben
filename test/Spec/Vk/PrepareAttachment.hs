  ...
  hspec $ do
    describe "getPhotoDocInfo" $ do
      ...
      it "throw CheckGetUploadServerResponseException on unknown getUploadServer response" $
        runStateT (getPhotoDocInfo handle6 5 "http://pic.jpg") []
          `shouldThrow` isCheckGetUploadServerResponseException
      it "throw CheckLoadToServResponseException on unknown loadToServer response" $
        runStateT (getPhotoDocInfo handle7 5 "http://pic.jpg") []
          `shouldThrow` isCheckLoadToServResponseException
      it "throw CheckSaveOnServResponseException on unknown saveOnServer response" $
        runStateT (getPhotoDocInfo handle8 5 "http://pic.jpg") []
          `shouldThrow` isCheckSaveOnServResponseException
      it "throw GetUploadServerException on getUploadServer HttpException" $
        runStateT (getPhotoDocInfo handle12 5 "http://pic.jpg") []
          `shouldThrow` isGetUploadServerException
      it "throw LoadToServException on loadToServer HttpException" $
        runStateT (getPhotoDocInfo handle13 5 "http://pic.jpg") []
          `shouldThrow` isLoadToServException
      it "throw SaveOnServException on saveOnServer HttpException" $
        runStateT (getPhotoDocInfo handle14 5 "http://pic.jpg") []
          `shouldThrow` isSaveOnServException
      it "throw GoToUrlException on goToUrl HttpException" $
        runStateT (getPhotoDocInfo handle15 5 "http://pic.jpg") []
          `shouldThrow` isGoToUrlException
    describe "getDocInfo" $ do
      it "work with photo attachment with user 6 doc_url=\"http://doc\"" $ do
        ...
        docInfo
          `shouldBe` DocInfo 25 50
      it "throw CheckGetUploadServerResponseException on unknown getUploadServer response" $
        runStateT (getDocInfo handle9 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isCheckGetUploadServerResponseException
      it "throw CheckLoadToServResponseException on unknown loadToServer response" $
        runStateT (getDocInfo handle10 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isCheckLoadToServResponseException
      it "throw CheckSaveOnServResponseException on unknown saveOnServer response" $
        runStateT (getDocInfo handle11 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isCheckSaveOnServResponseException
      it "throw GetUploadServerException on getUploadServer HttpException" $
        runStateT (getDocInfo handle16 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isGetUploadServerException
      it "throw LoadToServException on loadToServer HttpException" $
        runStateT (getDocInfo handle17 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isLoadToServException
      it "throw SaveOnServException on saveOnServer HttpException" $
        runStateT (getDocInfo handle18 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isSaveOnServException
      it "throw GoToUrlException on goToUrl HttpException" $
        runStateT (getDocInfo handle15 6 (Doc "http://doc" "hs" "MyDoc")) []
          `shouldThrow` isGoToUrlException
    describe "getAudioMsgDocInfo" $ do
      it "work with audioMsg attachment with user 4 doc_url=\"http://doc\"" $ do
        ...
        docInfo
          `shouldBe` DocInfo 25 50
      it "throw CheckGetUploadServerResponseException on unknown getUploadServer response" $
        runStateT (getAudioMsgDocInfo handle9 4 (Audio "http://doc")) []
          `shouldThrow` isCheckGetUploadServerResponseException
      it "throw CheckLoadToServResponseException on unknown loadToServer response" $
        runStateT (getAudioMsgDocInfo handle10 4 (Audio "http://doc")) []
          `shouldThrow` isCheckLoadToServResponseException
      it "throw CheckSaveOnServResponseException on unknown saveOnServer response" $
        runStateT (getAudioMsgDocInfo handle11 4 (Audio "http://doc")) []
          `shouldThrow` isCheckSaveOnServResponseException
      it "throw GetUploadServerException on getUploadServer HttpException" $
        runStateT (getAudioMsgDocInfo handle16 4 (Audio "http://doc")) []
          `shouldThrow` isGetUploadServerException
      it "throw LoadToServException on loadToServer HttpException" $
        runStateT (getAudioMsgDocInfo handle17 4 (Audio "http://doc")) []
          `shouldThrow` isLoadToServException
      it "throw SaveOnServException on saveOnServer HttpException" $
        runStateT (getAudioMsgDocInfo handle18 4 (Audio "http://doc")) []
          `shouldThrow` isSaveOnServException
      it "throw GoToUrlException on goToUrl HttpException" $
        runStateT (getAudioMsgDocInfo handle15 4 (Audio "http://doc")) []
          `shouldThrow` isGoToUrlException
